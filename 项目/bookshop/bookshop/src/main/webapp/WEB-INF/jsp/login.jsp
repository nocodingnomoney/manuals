...
<body>
    <div id="login-container">
        ...
        <br />
        <form>
            <input type="text" id="studentid" class="userName" placeholder="学号：201630"><br/>
            <input type="password" id="password" class="password" placeholder="密码：123456"><br/>
